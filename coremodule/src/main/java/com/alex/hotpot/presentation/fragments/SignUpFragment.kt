...
class SignUpFragment : Fragment(), KoinComponent {
    ...
    private fun updateViewState(viewState: com.alex.hotpot.presentation.LoginActivityViewState) {
        when (viewState) {
            com.alex.hotpot.presentation.LoginActivityViewState.SignUpWithUserAndPassword -> showProgressBar()
            ...
            com.alex.hotpot.presentation.LoginActivityViewState.SignUpFailed -> showSignUpFailedError()
            else -> {
            }
        }
    }
