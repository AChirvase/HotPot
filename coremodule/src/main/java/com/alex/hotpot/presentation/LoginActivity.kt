package com.alex.hotpot.presentation
...
import com.alex.hotpot.presentation.fragments.LoginFragment
import com.alex.hotpot.presentation.fragments.SignUpFragment
import com.alex.hotpot.utils.Constants.GOOGLE_SIGN_IN
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun startRestaurantsActivity() {
        intent = Intent()
        intent.setClassName("com.alex.restaurantsmodule", QuadrantConstants.RESTAURANTS_ACTIVITY)
